...
export const BrainCircuitIcon = ({ className }: { className?: string }) => (
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className={className}>
    <path d="M12 5a3 3 0 1 0-5.993.142" /><path d="M18 12a3 3 0 1 0-5.993.142" /><path d="M12 19a3 3 0 1 0-5.993.142" /><path d="M12 5a3 3 0 1 0 5.993.142" /><path d="M18 12a3 3 0 1 0 5.993.142" /><path d="M12 19a3 3 0 1 0 5.993.142" /><path d="M12 5a3 3 0 1 0-5.993.142" /><path d="M11.95 5a2.99 2.99 0 0 0-5.94.39" /><path d="m12 5 1.5 2.5" /><path d="m18 12-1.5-2.5" /><path d="M12 19l1.5-2.5" /><path d="M6 12l1.5 2.5" /><path d="m12 19-1.5-2.5" /><path d="m6 12-1.5-2.5" /><path d="m12 5-1.5 2.5" />
  </svg>
);
...
export const LibraryIcon = ({ className }: { className?: string }) => (
    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className={className}>
        ...
        <path d="M9 12v-3a3 3 0 0 1 6 0v3"/>
        <path d="M11.5 3.5a1.5 1.5 0 0 1 3 0"/>
        <path d="M14 12h-4"/>
        <path d="M16 16h-6"/>
    </svg>
);
...
export const SchoolIcon = ({ className }: { className?: string }) => (
    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className={className}>
        <path d="M14 22v-4a2 2 0 0 1 0-4 0v4" />
        <path d="M18 10v6" />
        <path d="M6 10v6" />
        <path d="M2 22h20" />
        <path d="M10 10c0-1.1.9-2 2-2s2 .9 2 2v6" />
        <path d="M2 10h20" />
        <path d="M12 2v.5" />
        <path d="M20 2v.5" />
        <path d="M4 2v.5" />
...
export const ScatterIcon = ({ className }: { className?: string }) => (
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className={className}>
...
export const ScatterPlotIcon = ({ className }: { className?: string }) => (
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className={className}>
    <circle cx="7.5" cy="7.5" r=".5" fill="currentColor" />
    <circle cx="18.5" cy="5.5" r=".5" fill="currentColor" />
    <circle cx="11.5" cy="11.5" r=".5" fill="currentColor" />
...
export const SigmaIcon = ({ className }: { className?: string }) => (
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className={className}>
...
export const PuzzleIcon = ({ className }: { className?: string }) => (
    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className={className}>
        <path d="M19.439 15.416c.815 1.367 2.561 1.367 3.376 0l.185-.31a2.048 2.048 0 0 0-.693-2.807l-.185-.11a2.048 2.048 0 0 1 .693-2.807l.185-.11c.815-1.367-.931-3.113-2.298-2.298l-.185.11a2.048 2.048 0 0 1-2.807-.693l-.11-.185a2.048 2.048 0 0 0-2.807.693l-.31.185c-1.367.815-1.367 2.561 0 3.376l.31.185c.756.45 1.015 1.418.565 2.174a1.599 1.599 0 0 1-2.174.565l-.31-.185z" />
        <path d="M4.561 15.416c-.815 1.367-2.561 1.367-3.376 0l-.185-.31a2.048 2.048 0 0 1 .693-2.807l.185-.11a2.048 2.048 0 0 0-.693-2.807l-.185-.11c-.815-1.367.931-3.113 2.298-2.298l.185.11a2.048 2.048 0 0 0 2.807-.693l.11-.185a2.048 2.048 0 0 1 2.807.693l.31.185c1.367.815 1.367 2.561 0 3.376l-.31.185a1.599 1.599 0 0 0-.565 2.174 1.599 1.599 0 0 0 2.174.565l.31-.185z" />
