...
export const NoticeBoardWidget = () => {
    ...
    return (
        <>
            <div className="bg-white dark:bg-slate-800 rounded-xl shadow-[0_4px_20px_rgba(0,0,0,0.03)] flex flex-col mb-6 overflow-hidden border border-slate-100 dark:border-slate-700">
